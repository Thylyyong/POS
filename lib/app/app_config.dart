...
class AppConfig {
  ...
  static const Color accentPrimary =
      ColorTheme.buttonPrimary; // Color(0xFF0D9488)
  static const Color accentBlue =
      ColorTheme.primary500; // Color(0xFF0D9488) - Clean Teal
  static const Color accentTeal = Color(0xFF0D9488);
  static const Color accentCyan = Color(0xFF0891B2);
  static const Color accentAmber =
      ColorTheme.semanticOrange; // Color(0xFFF97316)
  ...
  static const Color accentGreen =
      ColorTheme.semanticGreen; // Color(0xFF12974F)
  ...
  static const Color textSecondary =
      ColorTheme.textSecondary; // Color(0xFF475569)
